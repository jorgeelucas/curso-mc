...
public class ClienteResources {
	...
	public ResponseEntity<Void> insertClient(@Valid @RequestBody ClienteNewDTO dto) {
		Cliente cli = clienteService.fromDTO(dto);
		Cliente cliente = clienteService.inserir(cli);

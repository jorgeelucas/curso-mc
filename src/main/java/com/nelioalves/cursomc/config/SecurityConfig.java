...
import com.nelioalves.cursomc.security.JWTUtils;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String[] PUBLIC_MATCHES_READ_ONLY = {
			"/produtos/**",
			"/categorias/**"
	};
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
			...
			.antMatchers(HttpMethod.GET, PUBLIC_MATCHES_READ_ONLY).permitAll()
